# FoundPeers portfolio media handoff — 2026-07-26

- Replaced the FoundPeers case-study cover and gallery captures with the verified `final-2026-07-26` retina media set.
...
- Verified the new WebP reference on `https://www.khelifi-salmen.com/projects/foundpeers`.
