...
export const projects: Project[] = [
  ...
  },
  {
    ...
    gallery: [
      ...
      {
        src: "/images/foundpeers/foundpeers-create-profile.png",
        darkSrc: "/images/foundpeers/foundpeers-create-profile-dark.png",
        alt: "FoundPeers profile setup with Salmen's founder portrait, location consent, and founder focus controls",
        aspect: "phone",
      },
      {
        src: "/images/foundpeers/foundpeers-home.png",
        darkSrc: "/images/foundpeers/foundpeers-home-dark.png",
        alt: "FoundPeers Home dashboard showing a nearby sample founder and curated event",
        aspect: "phone",
      },
      {
        src: "/images/foundpeers/foundpeers-discover.png",
        darkSrc: "/images/foundpeers/foundpeers-discover-dark.png",
        alt: "FoundPeers Discover screen with Salmen marked as You, a safe own-profile action, realistic sample founders, and search controls",
        aspect: "phone",
      },
      {
        src: "/images/foundpeers/foundpeers-map.png",
        darkSrc: "/images/foundpeers/foundpeers-map-dark.png",
        alt: "FoundPeers live Da Nang map with Map and List modes, location sharing, current-location control, and founder markers",
        aspect: "phone",
      },
      {
        src: "/images/foundpeers/foundpeers-founder-profile.png",
        darkSrc: "/images/foundpeers/foundpeers-founder-profile-dark.png",
        alt: "FoundPeers high-resolution Sarah Chen founder profile with one clear connection action",
        aspect: "phone",
      },
      {
        src: "/images/foundpeers/foundpeers-request-sent.png",
        darkSrc: "/images/foundpeers/foundpeers-request-sent-dark.png",
        alt: "FoundPeers connection request sent confirmation screen",
        aspect: "phone",
      },
      {
        src: "/images/foundpeers/foundpeers-events.png",
        darkSrc: "/images/foundpeers/foundpeers-events-dark.png",
        alt: "FoundPeers Curated Events screen with a realistic Da Nang meetup example",
        aspect: "phone",
      },
      {
        src: "/images/foundpeers/foundpeers-profile.png",
        darkSrc: "/images/foundpeers/foundpeers-profile-dark.png",
        alt: "FoundPeers Salmen Khelifi account profile with a high-resolution portrait, links, visibility, revenue verification, and settings",
        aspect: "phone",
      },
    ],
    techStack: {
