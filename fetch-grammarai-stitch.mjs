...
const OUTPUT_DIR = "./nextjs-portfolio/public/images/stitch-projects";
const TARGET_PROJECT_ID = "14620193470260808168";
    ...
    for (const screen of screens) {
      try {
        ...
        if (imageUrl && imageUrl.startsWith("http")) {
          const filename = `${targetProject.projectId}-${screen.screenId}.png`;
